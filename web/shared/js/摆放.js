...
//
// 货有两种画法：给了 实体 名就走实体图渲染单闸；只给 料 就按料画 CSS 形状。
// （素材升级 06 之前，山楂 / 橘瓣 / 蘑菇 是「颗数就是答案、身份无所谓」的代表、走 料/CSS；
//  现已升实体、改走 实体 那条——CSS 料 这条路留着，给日后真的身份无所谓的形状用。）
...
/** 造一个「货」：有实体名就走实体图渲染单闸，否则按 料 画 CSS 形状。
 *
